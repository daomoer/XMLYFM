...
import HandyJSON
// 播放列表详情页数据模型
struct FMPlayDetailModel:HandyJSON {
    var album:FMPlayDetailAlbumModel?
    var user:FMPlayDetailUserModel?
    var tracks:FMPlayDetailTracksModel?
...
struct FMPlayDetailAlbumModel:HandyJSON {
    var albumId:Int = 0
...
struct FMPlayDetailUserModel:HandyJSON {
    var uid:Int = 0
    var nickname:String?
    var isVerified:Bool = false
...
struct FMPlayDetailTracksModel:HandyJSON {
    var list:[FMPlayDetailTracksListModel]?
}

struct FMPlayDetailTracksListModel:HandyJSON {
    var trackId:Int = 0
    var uid:Int = 0
    var duration:Int = 0
    var albumId:Int = 0
