...
class FindAttentionCell: UITableViewCell {
    ...
    lazy var collectionView : UICollectionView = {
        ...
        collectionView.register(FindAttentionPicCell.self, forCellWithReuseIdentifier:"FindAttentionPicCell")
...
extension FindAttentionCell: UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell:FindAttentionPicCell = collectionView.dequeueReusableCell(withReuseIdentifier: "FindAttentionPicCell", for: indexPath) as! FindAttentionPicCell
