...
class FindRecommendCell: UITableViewCell {
    ...
    lazy var collectionView : UICollectionView = {
        ...
        collectionView.register(FindRecommendPicCell.self, forCellWithReuseIdentifier:"FindRecommendPicCell")
...
extension FindRecommendCell: UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell:FindRecommendPicCell = collectionView.dequeueReusableCell(withReuseIdentifier: "FindRecommendPicCell", for: indexPath) as! FindRecommendPicCell
