...
class ListenMoreChannelController: UIViewController {
    ...
    private lazy var leftTableView : UITableView = {
        let tableView = UITableView.init(frame:CGRect(x:0, y:0, width:YYScreenWidth*0.2, height:YYScreenHeigth))
    ...
    private lazy var rightTableView : UITableView = {
        let tableView = UITableView.init(frame:CGRect(x:YYScreenWidth*0.2, y:0, width:YYScreenWidth*0.8, height: YYScreenHeigth), style: UITableViewStyle.grouped)
        tableView.delegate = self
        tableView.dataSource = self
...
extension ListenMoreChannelController : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if tableView == self.leftTableView {
            ...
            if row == oldRow && self.lastPath != nil {
                cell.titleLabel.textColor = DominantColor
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let lineView = UIView()
        lineView.frame = CGRect(x:80, y:20,width:YYScreenWidth*0.8-100, height:0.5)
      ...
      //  本次选中变亮色
        if tableView == self.leftTableView {
            ...
            if newRow != oldRow {
                ...
                newCell.titleLabel.textColor = DominantColor
