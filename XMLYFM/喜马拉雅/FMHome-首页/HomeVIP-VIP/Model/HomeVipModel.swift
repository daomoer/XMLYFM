...
struct HomeVipModel: HandyJSON {
    ...
    var categoryContents: CategoryContentsModel?
}
...
/// 滚动图片
struct FocusImagesData: HandyJSON {
    var adId: Int = 0
    var adType: Int = 0
...
struct CategoryContentsModel: HandyJSON {
    var list: [CategoryList]?
    var title: String?
}

// 滚动按钮
struct CategoryBtnModel: HandyJSON {
...
struct CategoryList: HandyJSON {
    ...
    var list: [CategoryContents]?
    var moduleType: Int = 0
    var tagName: String?
    var title: String?
}

struct CategoryContents: HandyJSON {
